...
echo ""
echo "=== Step 2: Verify Haar Cascade File Exists ==="
...
echo ""
echo "=== Step 4: Download Dependencies (Including OpenCV) ==="
...
echo ""
echo "=== Step 5: Verify OpenCV Dependency ==="
...
echo ""
echo "=== Step 6: Compile Source Code ==="
mvn compile
if [ $? -ne 0 ]; then
...
echo ""
echo "=== Step 8: Verify JAR File Created ==="
...
echo ""
echo "=== Step 9: Stop Existing Service ==="
...
echo ""
echo "=== Step 12: Check Recent Logs ==="
echo "Recent service logs:"
sudo journalctl -u sabs-java-service -n 50 --no-pager

echo ""
echo "=== Step 13: Test Java Service Endpoint ==="
sleep 5
