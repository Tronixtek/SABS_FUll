...
const Layout = () => {
  ...
  const navigation = [
    ...
    { name: 'Leave Requests', to: '/app/leave', icon: CalendarIcon, permission: 'view_leave_requests' },
    { name: 'Leave Policies', to: '/app/leave-policies', icon: Cog6ToothIcon, permission: 'manage_settings' },
